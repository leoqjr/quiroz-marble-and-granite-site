// src/components/site/estimate-page-client.tsx
"use client";
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 md:px-6 md:py-16">
      <div className="grid gap-10 md:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] md:items-start md:gap-16">
        ...
        {/* Right: Simple form */}
        <div
          className="rounded-2xl border border-[#E2E0DA] bg-[#FDFCF9] p-5 shadow-sm md:p-6
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              >
                ...
                <option value="onsite">On-site / jobsite meeting</option>
