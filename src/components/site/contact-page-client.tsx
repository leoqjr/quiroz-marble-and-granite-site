    ...
    <div className="mx-auto max-w-3xl px-4 py-12 md:px-6 md:py-16">
      ...
      <div className="space-y-4 md:space-y-5 text-center">
        ...
        <p className="text-sm leading-relaxed text-[#4B5563] md:text-[0.95rem]">
          Share a few details about your project and how to reach you. We’ll
          follow up to review scope, materials, and timing.
        </p>
      </div>
      ...
      <form
        ...
        className="mt-10 space-y-5 rounded-2xl border border-[#E2E0DA] bg-[#FDFCF9] p-5 shadow-sm md:mt-12 md:p-6
      ...
      >
        <div className="space-y-1">
          ...
          <p className="text-[13px] text-[#4B5563]">
            A brief description is enough. You can always share drawings or
            photos later.
          </p>
        </div>
      ...
      {/* Direct contact card */}
      <section
        className="mt-8 rounded-2xl border border-[#E2E0DA] bg-[#FDFCF9] px-5 py-5 md:mt-10 md:px-6
                   transition-all duration-200 ease-out
      ...
      >
        <div className="space-y-3 text-[13px] text-[#4B5563]">
          ...
          <p>
            Call or email if that’s easier for you. We serve clients across the
            greater Los Angeles area and surrounding communities.
          </p>
