...
const processSteps = [
  {
    ...
    body: "We review your plans or space, discuss use, and schedule on-site measurements where needed.",
  },
  {
    step: 2,
    title: "Material selection & design",
    body: "We align on stone type, color, edge profiles, and veining layouts for the space.",
  },
  {
    step: 3,
    title: "Precision fabrication",
    body: "Templates are translated into clean cuts, edges, and seams in our fabrication shop.",
  },
  {
    step: 4,
    title: "Professional installation",
    body: "Our team installs, protects surrounding finishes, and coordinates with other trades on site.",
  },
  {
    step: 5,
    title: "Final walkthrough & care",
    body: "We walk the space with you, confirm details, and review care and maintenance.",
  },
];
      ...
      <div className="mt-8 md:mt-0">
        <div className="relative overflow-hidden rounded-3xl border border-[#D8CBC3] bg-[#E5DED7] shadow-[0_18px_35px_rgba(15,23,42,0.10)]">
          <div className="relative aspect-[4/5] w-full">
            <Image
              src="/services-kitchen.jpg" // must exist in /public
  ...
  return (
    <section className="mx-auto max-w-3xl space-y-3 text-center">
      ...
      <p className="text-sm leading-relaxed text-[#4B5563] md:text-[0.95rem]">
        Quiroz Marble and Granite is a family-run shop serving the greater Los
        Angeles area with full-service stone work—from first measurements to
        final walkthrough. We manage templating, fabrication, and installation
        under one roof so details stay consistent throughout the project.
      </p>
      <p className="text-[11px] uppercase tracking-[0.18em] text-[#6B7280]">
        25+ years · Family-owned · Greater Los Angeles
      </p>
    </section>
  );
}
  ...
  return (
    <section className="space-y-6">
      <div className="space-y-2 md:space-y-3">
        ...
        <p className="max-w-xl text-sm leading-relaxed text-[#4B5563] md:text-[0.95rem]">
          Kitchens, baths, fireplaces, outdoor spaces, and custom details
          fabricated and installed by one team that focuses on calm, clean
          stonework.
        </p>
      </div>
  ...
  return (
    <section className="space-y-6">
      <div className="space-y-2 md:space-y-3">
        ...
        <p className="max-w-xl text-sm leading-relaxed text-[#4B5563] md:text-[0.95rem]">
          A calm, five-step process that keeps stone projects organized from
  ...
  return (
    <section className="space-y-6">
      <div className="space-y-2 md:space-y-3">
        ...
        <p className="max-w-xl text-sm leading-relaxed text-[#4B5563] md:text-[0.95rem]">
          We work directly with homeowners, alongside designers and architects,
          and as a trusted partner to contractors and builders.
        </p>
      </div>
      ...
      >
        <div className="space-y-1.5 md:max-w-xl">
          ...
          <p className="text-sm text-[#111827]">
            ...
            with a family-run team that’s been working with stone since 2000.
          </p>
          <p className="text-[11px] uppercase tracking-[0.18em] text-[#6B7280]">
